...
docker_bundle(
    ...
    images = {
        ...
        "docker.jfrog.io/jfrog/distroless/base/artifactory-sh:{BUILD_NUMBER}": "//base/artifactory-sh",
        ...
        "docker.jfrog.io/jfrog/distroless/base/distribution-sh:{BUILD_NUMBER}": "//base/distribution-sh",
